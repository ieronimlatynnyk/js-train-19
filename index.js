...
console.log("Чи є Novel прототипом Biography?");
console.log(Object.prototype.isPrototypeOf(Novel, Biography));
...
Object.defineProperty(ScienceBook, "info", {
  ...
  set: function (value) {
    console.error("Неможливо змінити значення 'info'.");
  },
  configurable: true,
  enumerable: true,
});
